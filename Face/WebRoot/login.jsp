...
<div class="login">
	<h1>检测</h1>
		...
		<input type="text" style="width:300px;" name="username" id="username"  placeholder="输入用户名" />
		
		
		<div id="support" align="center" ></div>
		<div align="center">
	    <video id="video" width="300" height="200" 
			 autoplay></video>
		</div>
		<canvas style="border:1px solid red;width:200px;height:40px;display:none;"
			id="canvas" ></canvas>
